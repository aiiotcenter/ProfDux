...
function questionEditMapSwitch(question, rootElement) {
    switch (question.type.toLowerCase()) {
        case "multiplechoicequestion":
            return new EditMultipleChoice(question, rootElement);
        case "trueandfalsequestion":
            return new EditTrueAndFalse(question, rootElement);
        case "fillintheblankquestion":
            return new EditFillInTheBlank(question, rootElement);
        default:
            throw new Error(`Not Made Yet: ${question.type.toLowerCase()}`);
    }
}
